...
_G.packer_plugins = {
  ...
  ctags = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/ctags",
  ...
  phpactor = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/phpactor",
    url = "https://github.com/phpactor/phpactor"
  },
  ["phpactor.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/phpactor.nvim",
